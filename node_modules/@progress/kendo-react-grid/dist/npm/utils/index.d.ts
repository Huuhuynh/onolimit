 ...
 * @hidden
 */
export declare function readColumns(elements: (React.ReactNode | React.ReactChild | GridColumnProps)[], oldColumns: GridColumnProps[], depth?: number): ExtendedColumnProps[];
/**
 * @hidden
 */
